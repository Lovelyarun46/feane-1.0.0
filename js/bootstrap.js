...
(function (global, factory) {
    ...
    var ClassName$4 = {
        ...
        DROPRIGHT: "dropright",
        DROPLEFT: "dropleft",
        WORKSRIGHT: "dropdown-WORKS-right",
        WORKSLEFT: "dropdown-WORKS-left",
        POSITION_STATIC: "position-static",
    };
    var Selector$4 = {
        DATA_TOGGLE: '[data-toggle="dropdown"]',
        FORM_CHILD: ".dropdown form",
        WORKS: ".dropdown-WORKS",
        NAVBAR_NAV: ".navbar-nav",
        VISIBLE_ITEMS:
            ".dropdown-WORKS .dropdown-item:not(.disabled):not(:disabled)",
    };
    var AttachmentMap = {
        TOP: "top-start",
        TOPEND: "top-end",
    ...
    var Dropdown =
        ...
        (function () {
            function Dropdown(element, config) {
                ...
                this._popper = null;
                this._config = this._getConfig(config);
                this._WORKS = this._getWORKSElement();
            ...
            _proto.toggle = function toggle() {
                ...
                var isActive = $(this._WORKS).hasClass(ClassName$4.SHOW);

                Dropdown._clearWORKSs();
                ...
                if (!this._inNavbar) {
                    ...
                    // to allow the WORKS to "escape" the scroll parent's boundaries
                ...
                $(this._WORKS).toggleClass(ClassName$4.SHOW);
                $(parent)
            ...
            _proto.show = function show() {
                if (
                    this._element.disabled ||
                    $(this._element).hasClass(ClassName$4.DISABLED) ||
                    $(this._WORKS).hasClass(ClassName$4.SHOW)
                ) {
                    return;
                }
            ...
            _proto._getWORKSElement = function _getWORKSElement() {
                if (!this._WORKS) {
                    var parent = Dropdown._getParentFromElement(this._element);

                    if (parent) {
                        this._WORKS = parent.querySelector(Selector$4.WORKS);
                    }
                }
            ...
            _proto._getPlacement = function _getPlacement() {
                ...
                if ($parentDropdown.hasClass(ClassName$4.DROPUP)) {
                    ...
                    if ($(this._WORKS).hasClass(ClassName$4.WORKSRIGHT)) {
                ...
                } else if ($(this._WORKS).hasClass(ClassName$4.WORKSRIGHT)) {
            ...
            Dropdown._clearWORKSs = function _clearWORKSs(event) {
                if (
                    event &&
                ...
                for (var i = 0, len = toggles.length; i < len; i++) {
                    ...
                    var dropdownWORKS = context._WORKS;
                    ...
                    $(dropdownWORKS).removeClass(ClassName$4.SHOW);
                    $(parent)
            ...
            Dropdown._dataApiKeydownHandler = function _dataApiKeydownHandler(
                ...
                //    - If trigger inside the WORKS => not a dropdown command
                if (
                    /input|textarea/i.test(event.target.tagName)
                        ? event.which === SPACE_KEYCODE ||
                          (event.which !== ESCAPE_KEYCODE &&
                              ((event.which !== ARROW_DOWN_KEYCODE &&
                                  ...
                                  $(event.target).closest(Selector$4.WORKS)
                                      .length))
    ...
    var Selector$9 = {
        ...
        DROPDOWN_TOGGLE: ".dropdown-toggle",
        DROPDOWN_ACTIVE_CHILD: "> .dropdown-WORKS .active",
        /**
         * ------------------------------------------------------------------------
         * Class Definition
         * ------------------------------------------------------------------------
    ...
    var Tab =
        ...
        (function () {
            ...
            _proto._transitionComplete = function _transitionComplete(
                ...
                if (
                    element.parentNode &&
                    $(element.parentNode).hasClass(ClassName$9.DROPDOWN_WORKS)
                ) {
